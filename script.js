...
function createThreeStarScene(mount) {
  ...
  /* Celestial twilight spark star (4-point) */
  const createSparkTexture = (size = 1024) => {
  ...
  const sparkTexture = createSparkTexture(1024);
